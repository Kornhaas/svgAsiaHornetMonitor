...
Nur geprüfte Boxen der Klassen `vespa_velutina`, `vespa_crabro`, `wasp`, `bee` und `other` werden exportiert. `empty` wird als Bild ohne Label-Datei aufgenommen. Der Split ist stabil: 70 % Training, 20 % Validierung, 10 % Test.
